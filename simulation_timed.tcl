...
proc finish {} {
    global ns nf tf qf tchan_ tcp_ll num_flows sendTimesList receiveTimesList result_path \
            ...
            bkg_request_id fr_cl_reqs_recv fr_serv_reqs_rcved frg_request_id log_fp TIME_start \
            total_bkg_cl_recv_time total_fan_cl_recv_time total_bkg_sv_recv_time \
            total_fan_sv_recv_time total_bkg_cl_recv_count total_fan_cl_recv_count \
            total_bkg_sv_recv_count total_fan_sv_recv_count
    ...
    puts "Total time taken: $TIME_taken"
    puts "Time taken by total_bkg_cl_recv_time: $total_bkg_cl_recv_time. Times called: $total_bkg_cl_recv_count"
    puts "Time taken by total_bkg_sv_recv_time: $total_bkg_sv_recv_time. Times called: $total_bkg_sv_recv_count"
    puts "Time taken by total_fan_cl_recv_time: $total_fan_cl_recv_time. Times called: $total_fan_cl_recv_count"
    puts "Time taken by total_fan_sv_recv_time: $total_fan_sv_recv_time. Times called: $total_fan_sv_recv_count"
    exit 0
}
...
# Profiling stuff
set total_bkg_cl_recv_time 0
set total_fan_cl_recv_time 0
set total_bkg_sv_recv_time 0
set total_fan_sv_recv_time 0

set total_bkg_cl_recv_count 0
set total_fan_cl_recv_count 0
set total_bkg_sv_recv_count 0
set total_fan_sv_recv_count 0
...
Application/TcpApp instproc bkg-client-recv { size server_id request_id } {
        global ns bkg_recv_times cl_reqs_recv total_bkg_cl_recv_time total_bkg_cl_recv_count
        incr total_bkg_cl_recv_count

        set start [clock clicks -milliseconds]
        # puts ">>>>$request_id $server_id"
        set bkg_recv_times($request_id) [$ns now]   
        incr cl_reqs_recv
        set time_taken [expr [clock clicks -milliseconds] - $start]
        set total_bkg_cl_recv_time [expr $total_bkg_cl_recv_time + $time_taken]
}
...
Application/TcpApp instproc client-recv { size server_id query_id wkld_indx} {
        ...
        #puts "================================================================"
        set time_taken [expr [clock clicks -milliseconds] - $start]
        set total_fan_cl_recv_time [expr $total_fan_cl_recv_time + $time_taken]
}

Application/TcpApp instproc bkg-server-recv { size server_id request_id } {
        global ns app_client_bkg app_server_bkg serv_reqs_rcved total_bkg_sv_recv_time total_bkg_sv_recv_count
        incr total_bkg_sv_recv_count
        set start [clock clicks -milliseconds]
        ...
        set time_taken [expr [clock clicks -milliseconds] - $start]
        set total_bkg_sv_recv_time [expr $total_bkg_sv_recv_time + $time_taken]
}
...
Application/TcpApp instproc server-recv { size server_id query_id wkld_id wkld_indx} {
        global ns app_server app_client sendTimesList receiveTimesList \
                 ...
                 mean_service_time_s app_client_ll app_server_ll total_fan_sv_recv_time total_fan_sv_recv_count
        ...
        #puts "------------------------------------------------------------------"
        set time_taken [expr [clock clicks -milliseconds] - $start]
        set total_fan_sv_recv_time [expr $total_fan_sv_recv_time + $time_taken]
