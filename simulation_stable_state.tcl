...
# To make sure that TCP has stabilized when fanout traffic starts
set fanout_start_time 20.0
set background_traffic_duration $traffic_duration
set foreground_traffic_duration $traffic_duration
set fanout_traffic_duration [expr $traffic_duration + $traffic_start_time - $fanout_start_time]
# in packets
...
if {$have_fanout_traffic} {
    for {set wkld 0} {$wkld < $num_workloads} {incr wkld} {
        ...
        set query_id 0
        set nextQueryTime [expr [$send_interval value] + $fanout_start_time]
        set traffic_end_time [expr $fanout_start_time + $fanout_traffic_duration]
